package com.buscala.motorista.deliverAll;
...
import com.buscala.motorista.BaseActivity;
import com.buscala.motorista.BuildConfig;
import com.buscala.motorista.CallScreenActivity;
...
//                    orderDetail.seteConfirm(generalFunc.getJsonValueStr("UserDistance", msg_obj));
                    ...
                    Picasso.get()
                            .load(Utilities.getResizeImgURL(getActContext(),vImage,imagewidth,imagewidth))
